...
class Order(models.Model):
    ...
    supplier    = models.ForeignKey('Supplier', blank=True, null=True, on_delete=models.CASCADE) #: Fk Supplier for this order
    ...
    expensecode = models.ManyToManyField('ExpenseCode', through='OrderExpenseCode', blank=True)  #: Budget of the supplied product
    currency    = models.ForeignKey('Currency', verbose_name='Currency', on_delete=models.CASCADE)             #: Currency of a Person salary
